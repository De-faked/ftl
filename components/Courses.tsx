...
import { Check, X, Clock, Utensils, Bus, Home, AlertCircle, FileText, ChevronDown } from 'lucide-react';
...
export const Courses: React.FC = () => {
  ...
  return (
    <>
    <section id="courses" className="py-12 sm:py-20 lg:py-24 bg-madinah-sand/30 relative" dir={dir}>
              ...
              >
                ...
                <div className={`flex flex-col h-full ${isExpanded ? 'lg:w-1/3 border-b lg:border-b-0 lg:border-r rtl:lg:border-r-0 rtl:lg:border-l border-gray-100' : 'w-full'}`}>
                    ...
                    <div className="p-6 md:p-8 flex-1 flex flex-col gap-5 md:gap-6">
                        ...
                        <div className="hidden md:grid grid-cols-2 gap-4 mb-1">
                        ...
                        <div className="flex flex-col gap-2 md:hidden">
                            ...
                            >
                                {isExpanded ? t.courses.close : 'Details'}
