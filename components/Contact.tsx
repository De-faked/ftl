...
export const Contact: React.FC = () => {
  ...
  return (
    <footer id="contact" className="bg-madinah-sand text-gray-900" dir={dir}>
      <div className="bg-madinah-green text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div className="space-y-1">
            <p className="text-sm uppercase tracking-wider font-semibold rtl:font-kufi">{t.contact.badge}</p>
            <h2 className="text-2xl font-serif font-bold rtl:font-kufi">{t.contact.title}</h2>
          </div>
          <div className="flex gap-3">
            <span className="px-4 py-2 rounded-full bg-white/10 text-sm font-semibold rtl:font-kufi">{t.contact.call}</span>
            <span className="px-4 py-2 rounded-full bg-white text-madinah-green font-bold" dir="ltr">+966 50 123 4567</span>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16">
          ...
          <div>
            <p className="text-sm font-semibold text-madinah-gold tracking-wide uppercase mb-3 rtl:font-kufi">{t.hero.aboutInstitute}</p>
            <h2 className="text-3xl font-serif font-bold mb-4 rtl:font-kufi">{t.contact.subtitle}</h2>
            <p className="text-gray-700 mb-8 text-lg rtl:font-amiri rtl:text-xl">
              {t.contact.description}
            </p>

            <div className="space-y-6">
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-full bg-madinah-green/10 flex items-center justify-center">
                  <Phone className="w-6 h-6 text-madinah-gold" />
                </div>
                <div>
                  <p className="text-sm text-gray-600 rtl:font-kufi">{t.contact.call}</p>
                  <p className="font-semibold rtl:font-kufi" dir="ltr">+966 50 123 4567</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-sm text-gray-600 rtl:font-kufi">{t.contact.email}</p>
                  <p className="font-semibold rtl:font-kufi">{INSTITUTE.email}</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-sm text-gray-600 rtl:font-kufi">{t.contact.visit}</p>
          ...
          <div className="bg-white rounded-2xl p-6 md:p-8 text-gray-800 shadow-sm">
      ...
      {/* Bottom Bar */}
      <div className="border-t border-madinah-green/20 bg-madinah-green text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-white/80 text-center md:text-left rtl:font-amiri">
            {t.contact.footer}
          </p>
          <div className="flex gap-3 md:gap-4">
            <a href="#" className="text-white hover:text-madinah-gold transition-colors p-3 rounded-full bg-white/10" aria-label="Instagram" title="Instagram">
              <Instagram className="w-5 h-5"/>
            </a>
            <a href="#" className="text-white hover:text-madinah-gold transition-colors p-3 rounded-full bg-white/10" aria-label="Twitter" title="Twitter">
              <Twitter className="w-5 h-5"/>
            </a>
            <a href="#" className="text-white hover:text-madinah-gold transition-colors p-3 rounded-full bg-white/10" aria-label="Facebook" title="Facebook">
