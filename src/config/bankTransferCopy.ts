...
const COPY: Record<Language, BankTransferCopy> = {
  ar: {
    ...
    labels: { bankName: 'البنك', accountHolder: 'اسم المستفيد', iban: 'رقم الحساب / الآيبان', swift: 'سويفت' },
  },
  en: {
    ...
    labels: { bankName: 'Bank', accountHolder: 'Account holder', iban: 'IBAN / Account No.', swift: 'SWIFT' },
  },
  id: {
    ...
    labels: { bankName: 'Bank', accountHolder: 'Nama pemilik rekening', iban: 'IBAN / No. Rekening', swift: 'SWIFT' },
  },
};
