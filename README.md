...
### Post-deploy checks
- Visit `https://www.ftl.ptdima.sa/some/path` and confirm it redirects to `https://ftl.ptdima.sa/some/path`.
- Run `curl -I https://ftl.ptdima.sa` and verify the security headers are present on the response.
