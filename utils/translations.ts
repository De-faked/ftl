...
export const translations = {
  ...
  allInclusive: {
    ...
    estimateRatesUnavailable: 'تعذر جلب أسعار الصرف الآن.',
      ...
      payment: {
        title: 'الدفع',
        requiredMessage: 'يلزم إكمال الدفع لتأكيد تسجيلك في PT Dima Khriza Group Co.',
        paidMessage: 'تم استلام الدفع بنجاح.',
        amountLabel: 'المبلغ:',
        payNow: 'ادفع الآن',
        paidBadge: 'تم الدفع',
        checkoutTitle: 'إتمام الدفع',
        checkoutSubtitle: 'راجع تفاصيل الدفع واضغط للمتابعة إلى بوابة PayTabs.',
        promoCodeTitle: 'رمز الخصم',
        promoCodePlaceholder: 'أدخل الرمز',
        apply: 'تطبيق',
        applying: 'جارٍ التطبيق...',
        promoApplied: 'تم تطبيقه',
        totalAfterDiscount: 'الإجمالي بعد الخصم',

        signInPrompt: 'سجّل الدخول لإتمام عملية الدفع.',
        ...
        returnSubtitle: 'نؤكد حالة الدفع من PayTabs. قد يستغرق الأمر بضع لحظات.',
        processing: 'جارٍ التحقق من حالة الدفع…',
        currentStatus: 'الحالة الحالية:',
        authorisedMessage: 'تم تأكيد الدفع بنجاح.',
        failedMessage: 'لم يكتمل الدفع. يمكنك إعادة المحاولة من البوابة.',
        stillProcessing: 'لا تزال المعالجة جارية. سنحاول التحقق مجددًا.',
        refresh: 'تحديث الحالة',
        refreshing: 'جارٍ التحديث…',
        backToPortal: 'العودة للبوابة',
        callbackNote: 'نعتمد على إشعار PayTabs النهائي. إذا استمرت المشكلة، تواصل مع الدعم.',
        statusLabels: {
          created: 'تم الإنشاء',
    ...
    admin: {
      ...
      payments: {
        title: 'المدفوعات',
        subtitle: 'إنشاء طلبات الدفع ومتابعة حالتها.',
        userIdLabel: 'معرّف المستخدم',
        userIdPlaceholder: 'UUID المستخدم',
        applicationIdLabel: 'معرّف الطلب (اختياري)',
        applicationIdPlaceholder: 'UUID الطلب',
        amountLabel: 'المبلغ',
        amountPlaceholder: 'مثال: 1000',
        currencyLabel: 'العملة',
        descriptionLabel: 'الوصف',
        descriptionDefault: 'رسوم الدراسة - PT Dima Khriza Group Co.',
        createButton: 'إنشاء طلب الدفع',
        creating: 'جارٍ الإنشاء…',
        createSuccess: 'تم إنشاء طلب الدفع.',
        ...
        reconcile: 'مصالحة',
        reconciling: 'جارٍ المصالحة…',
        reconcileSuccess: 'تم تحديث حالة الدفع.',
        errors: {
  ...
  allInclusive: {
    ...
    estimateRatesUnavailable: 'Rates unavailable.',
      ...
      payment: {
        title: 'Payment',
        requiredMessage: 'A payment is required to confirm your enrollment with PT Dima Khriza Group Co.',
        ...
        returnSubtitle: 'We are confirming the payment with PayTabs. This may take a moment.',
        processing: 'Checking payment status…',
        currentStatus: 'Current status:',
        authorisedMessage: 'Payment confirmed successfully.',
        failedMessage: 'Payment did not complete. You can try again from the portal.',
        stillProcessing: 'Processing is still underway. We will keep checking.',
        refresh: 'Refresh status',
        refreshing: 'Refreshing…',
        backToPortal: 'Back to portal',
        callbackNote: 'Final status is confirmed by PayTabs callback. Contact support if this persists.',
        statusLabels: {
          created: 'Created',
    ...
    admin: {
      ...
      payments: {
        title: 'Payments',
        subtitle: 'Create payment requests and monitor their status.',
        userIdLabel: 'User ID',
        userIdPlaceholder: 'User UUID',
        applicationIdLabel: 'Application ID (optional)',
        applicationIdPlaceholder: 'Application UUID',
        amountLabel: 'Amount',
        amountPlaceholder: 'e.g. 1000',
        currencyLabel: 'Currency',
        descriptionLabel: 'Description',
        descriptionDefault: 'Tuition payment - PT Dima Khriza Group Co.',
        createButton: 'Create payment request',
        creating: 'Creating…',
        ...
        reconcileSuccess: 'Payment status updated.',
        errors: {
  ...
  allInclusive: {
    ...
    estimateRatesUnavailable: 'Kurs tidak tersedia.',
      ...
      payment: {
        title: 'Pembayaran',
        requiredMessage: 'Pembayaran diperlukan untuk mengonfirmasi pendaftaran Anda di PT Dima Khriza Group Co.',
        paidMessage: 'Pembayaran Anda telah diterima.',
        amountLabel: 'Jumlah:',
        payNow: 'Bayar sekarang',
        paidBadge: 'Lunas',
        checkoutTitle: 'Pembayaran',
        checkoutSubtitle: 'Tinjau detail pembayaran Anda dan lanjutkan ke halaman PayTabs.',
        promoCodeTitle: 'Kode promo',
        promoCodePlaceholder: 'Masukkan kode',
        apply: 'Terapkan',
        applying: 'Menerapkan...',
        promoApplied: 'Diterapkan',
        totalAfterDiscount: 'Total setelah diskon',

        signInPrompt: 'Masuk untuk menyelesaikan pembayaran.',
        signInButton: 'Masuk',
        ...
        returnSubtitle: 'Kami sedang mengonfirmasi pembayaran di PayTabs. Ini mungkin membutuhkan waktu.',
        processing: 'Memeriksa status pembayaran…',
        currentStatus: 'Status saat ini:',
        authorisedMessage: 'Pembayaran berhasil dikonfirmasi.',
        failedMessage: 'Pembayaran tidak berhasil. Anda dapat mencoba lagi dari portal.',
        stillProcessing: 'Pemrosesan masih berlangsung. Kami akan terus memeriksa.',
        refresh: 'Segarkan status',
        refreshing: 'Menyegarkan…',
        backToPortal: 'Kembali ke portal',
        callbackNote: 'Status akhir dikonfirmasi oleh callback PayTabs. Hubungi dukungan jika masih terjadi.',
        statusLabels: {
          created: 'Dibuat',
          redirected: 'Dialihkan',
          authorised: 'Disetujui',
          failed: 'Gagal',
    ...
    admin: {
      ...
      payments: {
        title: 'Pembayaran',
        subtitle: 'Buat permintaan pembayaran dan pantau statusnya.',
        userIdLabel: 'ID Pengguna',
        userIdPlaceholder: 'UUID pengguna',
        applicationIdLabel: 'ID Aplikasi (opsional)',
        applicationIdPlaceholder: 'UUID aplikasi',
        amountLabel: 'Jumlah',
        amountPlaceholder: 'contoh: 1000',
        currencyLabel: 'Mata uang',
        descriptionLabel: 'Deskripsi',
        descriptionDefault: 'Pembayaran biaya kuliah - PT Dima Khriza Group Co.',
        createButton: 'Buat permintaan pembayaran',
        creating: 'Membuat…',
        createSuccess: 'Permintaan pembayaran dibuat.',
        ...
        reconcileSuccess: 'Status pembayaran diperbarui.',
        errors: {
